              ...
              <div class="file-listing-wrapper">
                <div class="file-box">
                  ...
                  <div class="icons-wrap">
                    ...
                    <div
                      class="icons-bar"
                      v-if="file.user_id == file.login_user_id"
                    >
                      <a
                        href=""
                        v-confirm="{
                          loader: true,
                          ok: dialog => deletFile(dialog, file_index),
                          cancel: doNothing,
...
export default {
  ...
  methods: {
    ...
    async deletFile(dialog, file_index) {
      const $this = this;
      let file_id = $this.project_files.data[file_index].id;

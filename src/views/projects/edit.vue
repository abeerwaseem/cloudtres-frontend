...
<script>
import adminvue from "./update/admin-edit-project";
import salesteamleadvue from "./update/salesteamlead-edit-project";
import salespersonvue from "./update/salesperson-edit-projecct";

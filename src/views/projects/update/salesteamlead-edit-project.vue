            ...
            <div class="col-sm-12">
              <div class="row">
                ...
                <div class="col-sm-12">
                  <form
                    class="project-form"
                    v-on:submit.prevent="onUpdate($event)"
                  >
                    <div class="row">
                      <div class="col-sm-12">
                        <div class="row">
...
export default {
  ...
  methods: {
    async getprojectdetail() {
      ...
      await window.axios
        .get(
          `/projects/edit/${$this.$route.params.project_id}?timezone=${this.formData.timezone}`
        )
        .then(resps => {
          $this.formData.project_name = resps.data.data.project_name;
          $this.formData.brand_id = resps.data.data.project_brand;
          $this.formData.am_id = resps.data.data.project_account_manager;
          $this.formData.client_id = resps.data.data.project_clients;
          $this.formData.category_id = resps.data.data.project_category;
          $this.formData.project_status = resps.data.data.project_status;
          $this.formData.in_house_team_member = resps.data.data.inhousemembers;
          $this.formData.start_date = resps.data.data.start_date;
          $this.formData.end_date = resps.data.data.deadline;
          $this.formData.project_summary = resps.data.data.project_summary;
          $this.formData.project_note = resps.data.data.notes;
    ...
    async onUpdate(event) {
      ...
      const data = $this.$store.dispatch("postHttp", {
        url: `projects/update/${$this.$route.params.project_id}`,
    ...
    async getprojectbrands() {
      const $this = this;
      await window.axios
        .get("/filters/get-project-brand")
        .then(resps => {
          $this.brand_options = resps.data.data;
        })
        .catch(function(error) {
          $this.$store.dispatch("displayMessageErrors", {
            response: error.response,
    ...
    async getProjectCategory(brandid) {
      const $this = this;
      await window.axios
        .get("/filters/get-project-category")
        .then(resps => {
          $this.cat_options = resps.data.data;
        })
        .catch(function(error) {
          $this.$store.dispatch("displayMessageErrors", {
            response: error.response,
    ...
    async getProjectStatusCategory(brandid) {
      const $this = this;
      await window.axios
        .get("/filters/get-project-status-category")
        .then(resps => {
          $this.status_options = resps.data.data;
        })
        .catch(function(error) {
          $this.$store.dispatch("displayMessageErrors", {
            response: error.response,
    ...
    async getProjectInhouseMembers(brandid) {
      const $this = this;
      await window.axios
        .get("/filters/get-inhouse-team-members")
        .then(resps => {
          $this.inhouse_team_options = resps.data.data;
        })
        .catch(function(error) {
          $this.$store.dispatch("displayMessageErrors", {
            response: error.response,
    ...
    getAmOfBrand() {
      ...
      // if ($this.formData.brand_id) {
      //   $this.getProjectAms($this.formData.brand_id);
      //   $this.getProjectClients($this.formData.brand_id);
      // } else {
      //   $this.ams_options = null;
      // }
    },
